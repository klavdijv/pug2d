...
import sf
from pug2d import core, actions, behaviors
#from pug2d.support import EventList, EventMask, EventCallback, InputHandler
...
class Level1(core.Level):
    def __init__(self):
        ...
        behavior = behaviors.DefaultBehavior()
        dir8 = actions.EightDirMovement(100, 100)
        actor = core.Actor(sprite, behavior=behavior)
        actor.add_action(dir8)
